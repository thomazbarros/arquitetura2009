...
public class ManipulaMemoria {
	...
	ManipulaMemoria(Arquitetura arquitetura){
	...
	public String getConstanteInstrucao(String instrucao){
		...
		if(instrucao.equals("xchg")){
			return Constantes.XCHG;
		}
	...
	public int ler(int posicao){
		...
		if(binario.substring(0, 1).equals("1")){
			...
			System.out.println("INSTRUCAO DE AGORA:"+parser.decifraInstrucao(binario));
			if(arquitetura.getModo() == Constantes.RODAINSTRUCAO){
				arquitetura.mostraPontosDeControle();
			}
			return -1;
		}
		if(isLabel(binario)){
	...
	public void decodificaInstrucao(String binario){
		...
		if(instrucao.equals(Constantes.XCHG)){
			xchg(binario);
			return;
		}
	...
	public void xchg(String binario){
		int funcao;
		...
		switch(funcao){
		case 1:
			instrucao.xchg1(getRegistradorFonte(binario.substring(8,12)),getRegistradorDestino(binario.substring(12,16)));
			break;
		case 2:
			instrucao.xchg2(getRegistradorFonte(binario.substring(8,12)),getRegistradorDestino(binario.substring(12,16)));			
			break;
		case 3:
			instrucao.xchg3(getRegistradorFonte(binario.substring(8,12)),getRegistradorDestino(binario.substring(12,16)));			
			break;
		case 4:
			instrucao.xchg4(getRegistradorFonte(binario.substring(8,12)),getRegistradorDestino(binario.substring(12,16)));			
		}
	}
